...
#main variables
API_ID = int(environ.get('API_ID', '27672739'))
API_HASH = environ.get('API_HASH', 'f48d0da94f2622364ab24eb0d911903c')
BOT_TOKEN = environ.get('BOT_TOKEN', '8088534251:AAFwOd8-S6NCucBb-unMGh4QZKYabU3Sq7g')

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5069198943').split()]
USERNAME = environ.get('USERNAME', "https://t.me/starboyromantic")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002318997215'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/khaanmovies')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002434765617').split()]
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002318997215'))
...
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002031180571'))
URL = environ.get('URL', 'mytestbot-jvdfhbj.com')
STICKERS_IDS = ('CAACAgQAAxkBAAEK99dlfC7LDqnuwtGRkIoacot_dGC4zQACbg8AAuHqsVDaMQeY6CcRojME').split()
FILE_AUTO_DEL_TIMER = int(environ.get('FILE_AUTO_DEL_TIMER', '600'))
IS_VERIFY = is_enabled('IS_VERIFY', True)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002031180571'))
